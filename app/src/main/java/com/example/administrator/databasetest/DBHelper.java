...
public class DBHelper extends SQLiteOpenHelper {
    ...
    private final static String DB_NAME = "Item.db";
    private final static String TABLE_NAME = "item";
    private final static String CREATE_TBL = "create table item(_id integer primary key autoincrement, name text, ip text, port text)";
